          ...
          children: [
            Text(
              ...
              style: TextStyle(
                ...
                fontFamily: 'Pacifico', // Cambia la tipografía
              ),
            ),
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: "Buscar",
                hintStyle: TextStyle(color: Colors.white.withOpacity(0.6)), // Cambia el estilo del texto de sugerencia
                prefixIcon: const Icon(Icons.search, color: Colors.white), // Cambia el color del ícono de búsqueda
              ),
            ),
            const SizedBox(height: 20.0),
            Expanded(
             child: displayList.length == 0 ?Center(child: Text("No Hay Resultados", style: TextStyle(color: Colors.white, fontSize: 22.0, fontWeight: FontWeight.bold ),),):
               ListView.builder(
                ...
                itemBuilder: (context, index) => ListTile(
                  ...
                  style: TextStyle(
                    color: Colors.white.withOpacity(0.6) // Cambia el color del texto del subtítulo
                    ),
                  ),
